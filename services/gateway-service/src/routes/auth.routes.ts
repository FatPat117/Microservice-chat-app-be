import { loginUser, refreshTokens, registerUser, revokeRefreshToken } from "@/controllers/auth.controller";
...
authRouter.post('/revoke',validateRequest({body:revokeSchema}),asyncHandler(revokeRefreshToken))
